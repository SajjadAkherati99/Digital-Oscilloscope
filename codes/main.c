...
int main()
{
	...
	int sign_vtime_plus = 0, sign_vtime_minus = 0;
	...
	while(1){
		...
		if ((sign_vtime_plus == 0) && (IO0PIN&0x00000008) == 0x00000008){
			v_p_time = v_p_time + 2;
			sign_vtime_plus = 1;
		}
		else if ((sign_vtime_plus == 1) && (IO0PIN&0x00000008) == 0x00000000){
			sign_vtime_plus = 0;
		}
		
		if ((sign_vtime_minus == 0) && (IO0PIN&0x00000010) == 0x00000010){
			if (v_p_time > 1)
				v_p_time = v_p_time - 2;
			sign_vtime_minus = 1;
		}
		else if ((sign_vdive_minus == 1) && (IO0PIN&0x00000010) == 0x00000000){
			sign_vtime_minus = 0;
		}
